...
<head>
    ...
    <title>Акции — Музей Ароматов</title>
    ...
    <div class="container">
        ...
        <main class="main-sale">
            <section class="block-sale">
                <img class="block-sale__img" src="../content/images/img-sale.png" alt="Акция">
                <div class="block-sale__text">
                    <p class="block-sale__text-name">Магазин <br>
                        «Музей ароматов»: <br>
                        Погрузитесь в историю <br> парфюмерии</p>
                    <p class="block-sale__text-description">Откройте для себя ароматы, вдохновленные <br> великими
                        эпохами и легендарными мастерами</p>
                    <button class="btn-sale">Перейти в магазин</button>
                    <img class="block-sale__text--img" src="../content/images/avatars.png" alt="аватарки">
                </div>
            </section>
        </main>
    </div>
